...
const ZodiacDetails = () => {
  ...
  return (
    <div className="pb-20 md:pb-0">
      ...
      {catalogueItem && expertGuides.length > 0 && (
        <div className="fixed bottom-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md p-4 border-t border-gray-100 shadow-[0_-8px_30px_rgb(0,0,0,0.06)] md:hidden flex items-center justify-between">
          <div className="flex flex-col text-left">
            <p className="text-[10px] text-gray-500 uppercase tracking-wider font-semibold">Catalogue Reading</p>
            <p className="text-base font-bold text-gray-800 truncate max-w-[180px]">
              {catalogueItem.name}
            </p>
          </div>
          <button
            onClick={() => handleWhatsAppBooking(expertGuides[0])}
