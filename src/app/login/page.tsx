      ...
      <div className="w-full flex flex-col lg:flex-row justify-between items-center px-4 sm:px-8 md:px-16 py-6 md:py-10 gap-8 md:gap-0 md:pt-0 pt-30">
        ...
        <div className="relative z-10 px-4 lg:px-6 text-center md:text-left w-full lg:w-auto md:h-auto h-[60vh] flex flex-col justify-center">
          <Image
            ...
            priority
            unoptimized
            className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[85vw] h-[85vw] sm:w-[70vw] sm:h-[70vw] md:w-[50vw] md:h-[50vw] lg:w-[42vw] lg:h-[42vw] xl:w-[38vw] xl:h-[38vw] max-w-[850px] max-h-[850px] aspect-square object-contain opacity-20 rounded-full animate-spin-slow pointer-events-none select-none z-0"
