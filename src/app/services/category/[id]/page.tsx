...
const UserDetailsModal = ({
  ...
  const isEnergyHealing =
    categoryName?.toLowerCase().includes("energy healing") ||
      ...
      <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
        ...
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {isEnergyHealing && (
              <div className="flex items-start gap-3 p-4 bg-purple-50 rounded-xl border border-purple-100 select-none mb-2">
                <input
                  type="checkbox"
                  id="energy-healing-consent-cat"
                  checked={consentChecked}
                  onChange={(e) => setConsentChecked(e.target.checked)}
                  className="w-5 h-5 mt-0.5 text-purple-600 border-gray-300 rounded focus:ring-purple-500 cursor-pointer"
                />
                <label
                  htmlFor="energy-healing-consent-cat"
