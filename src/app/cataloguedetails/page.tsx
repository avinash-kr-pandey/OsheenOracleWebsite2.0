 ...
 const fetchData = async () => {
   try {
     ...
     if (item && item.id) {
       ...
       // Find from static zodiacData by id (convert both to string for comparison)
       console.log("Looking in static data for id:", id);
       const staticItem = defaultCatalogueItems.find(
         (staticItem) =>
           String(staticItem.id) === String(id) || staticItem._id === id,
       );

       console.log("Static item found:", staticItem);

       if (staticItem) {
         setCatalogueItem(staticItem);
         setUsingStaticData(true);
       } else {
         console.error("No item found in static data for id:", id);
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-pink-50 flex items-center justify-center p-4">
        <div className="text-center max-w-7xl mx-auto">
          ...
          <p className="text-gray-600 mb-6">
            The reading you&rsquo;re looking for doesn&rsquo;t exist or
  ...
  return (
    <div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 mt-4">
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 text-center">
            <p className="text-yellow-700 text-sm">
              * Showing sample data. Connect to internet for live readings.
            </p>
          </div>
        </div>
      )}
      ...
      {/* Final CTA Section */}
      <section className="container w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
